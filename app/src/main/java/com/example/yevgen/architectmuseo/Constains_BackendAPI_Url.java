...
public class Constains_BackendAPI_Url {
    ...
    public final String URL_Sond_Cloud = "https://api.soundcloud.com/tracks/228179666/stream?client_id=76bf4a478f95a82ca090ecd8fa5b99db";// trackid is only one variable
}
