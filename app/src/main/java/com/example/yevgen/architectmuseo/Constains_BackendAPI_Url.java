...
public class Constains_BackendAPI_Url {
    ...
    public static final String URL_POIDetail =
            "http://dev.mw.metropolia.fi/mofa/Wikitude_1/geoLocator/poi_detail.php?id=";

    public static final String URL_Sond_Cloud = "https://api.soundcloud.com/tracks/228179666/stream?client_id=76bf4a478f95a82ca090ecd8fa5b99db";// trackid is only one variable
}
